...
Enterprise security automation for identifying legitimate email campaigns quarantined because of DMARC failure, presenting those campaigns for analyst review, releasing approved messages, creating investigation tickets, and optionally adding approved senders to the Microsoft Tenant Allow/Block List.
